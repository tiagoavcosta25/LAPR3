...
CREATE TABLE Address (id number(10) GENERATED AS IDENTITY, latitude float(100) NOT NULL, longitude float(100) NOT NULL, doorNumber varchar2(40) NOT NULL, streetName varchar2(100) NOT NULL, postalCode varchar2(8) NOT NULL, locality varchar2(70) NOT NULL, country varchar2(50) NOT NULL, PRIMARY KEY (id));
