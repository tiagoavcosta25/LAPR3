...
CREATE TABLE Battery (id number(10) GENERATED AS IDENTITY, batteryPerc double precision NOT NULL, batteryCapacity number(10) NOT NULL, batteryVoltage double precision NOT NULL, PRIMARY KEY (id));
...
CREATE TABLE "Order" (id number(10) GENERATED AS IDENTITY, description varchar2(255), orderDate date NOT NULL, totalWeight double precision NOT NULL, amount double precision NOT NULL, additionalFee double precision DEFAULT 0 NOT NULL, isHomeDelivery number(1) NOT NULL, clientId number(10) NOT NULL, orderStatus varchar2(20) NOT NULL, pharmacyId number(10) NOT NULL, deliveryRunId number(10) NOT NULL, PRIMARY KEY (id));
...
CREATE TABLE Path (addressIdA number(10) NOT NULL, addressIdB number(10) NOT NULL, name varchar2(255) NOT NULL, PRIMARY KEY (addressIdA, addressIdB));
...
CREATE TABLE Vehicle (id number(10) GENERATED AS IDENTITY, potency double precision NOT NULL, weight double precision NOT NULL, maxPayload double precision NOT NULL, pharmacyId number(10) NOT NULL, batteryId number(10) NOT NULL UNIQUE, PRIMARY KEY (id));
