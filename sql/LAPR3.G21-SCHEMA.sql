...
DROP TABLE CreditCard_Client CASCADE CONSTRAINTS;
...
CREATE TABLE Client (Userid number(10) NOT NULL, name varchar2(255) NOT NULL, nif number(10), credits number(10), Addressid number(10) NOT NULL, PRIMARY KEY (Userid));
CREATE TABLE Consumption (id number(10) GENERATED AS IDENTITY, Orderid number(10) NOT NULL, PRIMARY KEY (id));
CREATE TABLE Courier (Userid number(10) NOT NULL, name varchar2(255), nif number(10), iban varchar2(255), PRIMARY KEY (Userid));
CREATE TABLE CreditCard (creditCardNr number(10) GENERATED AS IDENTITY, ClientUserid number(10) NOT NULL, validityDate varchar2(255), ccv number(10), PRIMARY KEY (creditCardNr));
CREATE TABLE CreditCard_Client (CreditCardcreditCardNr number(10) NOT NULL, ClientUserid number(10) NOT NULL, PRIMARY KEY (CreditCardcreditCardNr, ClientUserid));
...
CREATE TABLE PaymentMethodInvoice (CreditCardcreditCardNr number(10) NOT NULL, Invoiceid number(10) NOT NULL, value float(10), PRIMARY KEY (CreditCardcreditCardNr, Invoiceid));
...
ALTER TABLE PaymentMethodInvoice ADD CONSTRAINT FKPaymentMet946770 FOREIGN KEY (CreditCardcreditCardNr) REFERENCES CreditCard (creditCardNr);
ALTER TABLE PaymentMethodInvoice ADD CONSTRAINT FKPaymentMet570514 FOREIGN KEY (Invoiceid) REFERENCES Invoice (id);
ALTER TABLE CreditCard_Client ADD CONSTRAINT FKCreditCard52785 FOREIGN KEY (CreditCardcreditCardNr) REFERENCES CreditCard (creditCardNr);
ALTER TABLE CreditCard_Client ADD CONSTRAINT FKCreditCard473912 FOREIGN KEY (ClientUserid) REFERENCES Client (Userid);
