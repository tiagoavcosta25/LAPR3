CREATE OR REPLACE FUNCTION getAvailableChargingSlot(strEmail "User".EMAIL%type) RETURN SYS_REFCURSOR AS
    RFC SYS_REFCURSOR;
    chargingSlot_not_found exception;
BEGIN

    SELECT CS.ID,P.PHARMACYID, PH.NAME, PH.ADDRESSID, PH.NAME, AD.LATITUDE, AD.LONGITUDE, AD.DOORNUMBER,
