...
public class ScooterTest {
    ...
    @Test
    void testToString() {
        String expected = "Scooter{Id = -1, Battery Perc = -1.0, Chargin Status = Not Charging, Potency = -1.0, Weight = -1.0," +
                " Battery Capacity = -1, Max Payload = -1.0, Pharmacy = Pharmacy{m_intId=-1, m_strName='No name.', " +
                "m_oAddress=Address{m_id=-1, m_latitude=-22.0, m_longitude=-22.0, m_streetName='No Street Name', " +
                "m_doorNumber='No Door Number', m_postalCode='No Postal Code', m_locality='No Locality', m_country='No Country'}, m_mapStock={}}}";
