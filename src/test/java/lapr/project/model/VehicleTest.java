...
class VehicleTest {
    ...
    @Test
    void testToString() {
        String expected = "Vehicle{Id=-2, PharmacyId=0, Potency=200.0, Weight=200.0, MaxPayload=20.0, " +
                "CharginStatus='Not Charging', Battery=Battery{Id=0, BatteryPerc=32.0, BatteryCapacity=100, " +
                "BatteryVoltage=32.0}, Pharmacy=Pharmacy{m_intId=-1, m_strName='No name.', " +
                "m_oAddress=Address{m_id=-1, m_latitude=-22.0, m_longitude=-22.0, m_streetName='No Street " +
                "Name', m_doorNumber='No Door Number', m_postalCode='No Postal Code', " +
                "m_locality='No Locality', m_country='No Country'}, m_mapStock={}}}";
