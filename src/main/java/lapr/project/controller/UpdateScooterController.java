...
public class UpdateScooterController {
    ...
    public boolean updateScooter(int intBatteryPerc, int intCharginStatus, int intPotency,
                              int intWeight, int intBatteryCapacity){

        this.m_oScooterRegistration = m_oPlatform.getScooterReg();
        return m_oScooterRegistration.updateScooterFromDB(intBatteryPerc, intCharginStatus, intPotency, intWeight,
                intBatteryCapacity);
    }
