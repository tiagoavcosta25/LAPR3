...
public class Battery {
    ...
    public Battery() {
        this.mintId = DEFAULT_ID;
        this.mintBatteryCapacity = DEFAULT_BATTERY_CAPACITY;
        this.mdlbBatteryVoltage = DEFAULT_BATTERY_VOLTAGE;
        this.mdblEfficiency = DEFAULT_EFFICICIENY;
    }
