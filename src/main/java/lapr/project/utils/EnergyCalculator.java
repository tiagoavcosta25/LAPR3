...
public class EnergyCalculator {
    ...
    public static Pair<Double, Double> calculateScooterEnergy(double distanceUsingCoordinates, double windDegree, double windSpeed,
        ...
        return new Pair<>(totalForca * distanceUsingCoordinates / KILOWATTHOUR, time);     //kWh ou J
    }
    public static Pair<Double, Double> calculateDroneEnergy(double totalWeight, double windSpeed, double windDegree, double distance){
        ...
        return new Pair<>(totalEnergy/KILOWATTHOUR, time);
    }
}
